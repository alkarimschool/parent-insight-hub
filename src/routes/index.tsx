...
import { fetchHomepage, fetchWebsite } from "@/lib/settings";
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-20 text-center sm:px-6 sm:py-28">
          ...
          <h1 className="mt-6 text-4xl font-bold tracking-tight text-foreground sm:text-6xl">
            {h?.hero_title ?? "Parent Awareness Assessment"}
          </h1>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold text-foreground sm:text-4xl">{h?.why_title}</h2>
          {h?.why_subtitle && <p className="mt-3 text-muted-foreground">{h.why_subtitle}</p>}
        </div>
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {h?.why_items?.map((it, i) => (
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold text-foreground sm:text-4xl">{h?.benefits_title}</h2>
        </div>
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {h?.benefits_items?.map((it, i) => (
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold text-foreground sm:text-4xl">{h?.how_title}</h2>
        </div>
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {h?.how_items?.map((it, i) => (
            <div key={i} className="rounded-2xl border border-border/60 bg-gradient-card p-6 shadow-soft">
      ...
      <section className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
        <h2 className="text-center text-3xl font-bold text-foreground sm:text-4xl">{h?.faq_title}</h2>
