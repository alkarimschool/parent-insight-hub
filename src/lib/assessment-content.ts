...
export const ASSESSMENT_CONTENT_MAP: Record<EducationLevel, AssessmentLevelConfig> = {
  ...
  SMA: {
    badge: "Laporan Pemetaan Kemampuan Awal Siswa Kelas X SMA",
    title: "Pemetaan Kemampuan Awal Siswa Kelas X SMA",
    ...
    reportTitle: "Laporan Pemetaan Kemampuan Awal Siswa Kelas X SMA",
    metadataTitle: "Laporan Pemetaan Kemampuan Awal Siswa Kelas X SMA",
